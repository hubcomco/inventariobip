        ...
        <div class="row">
            <div class="col-md-12">
                <div class="form-group">
                    ...
                    <input id="vc_email_personal" name="vc_email_personal" type="email" class="form-control" required>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="form-group">
                    ...
                    <input id="vc_usuario_DA" name="vc_usuario_DA" type="text" class="form-control" required>
                </div>
            </div>
        </div>
...
<!-- Mensaje de creación de empleado -->
@if (session('success'))
